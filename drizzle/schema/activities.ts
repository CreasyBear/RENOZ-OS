...
import { pgTable, uuid, text, jsonb, index, inet } from "drizzle-orm/pg-core";
import { activityActionEnum, activityEntityTypeEnum, activitySourceEnum } from "./enums";
...
export const activities = pgTable(
  ...
  (table) => ({
    ...
    userIdx: index("idx_activities_user").on(table.userId, table.createdAt),
