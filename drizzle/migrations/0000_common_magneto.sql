...
CREATE TYPE "public"."campaign_recipient_status" AS ENUM('pending', 'sent', 'delivered', 'opened', 'clicked', 'bounced', 'failed', 'unsubscribed');--> statement-breakpoint
...
CREATE TABLE "attachments" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"deleted_at" timestamp with time zone,
	CONSTRAINT "attachments_entity_type_check" CHECK ("attachments"."entity_type" IS NULL OR "attachments"."entity_type" IN ('customer', 'contact', 'order', 'opportunity', 'product', 'inventory', 'supplier', 'warranty', 'issue', 'user', 'email', 'call', 'job', 'job_assignment', 'warranty_claim', 'quote', 'shipment'))
);
--> statement-breakpoint
...
CREATE TABLE "scheduled_reports" (
	...
	"recipients" jsonb DEFAULT '{"emails":[]}'::jsonb,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	"created_by" uuid,
	"updated_by" uuid
...
CREATE INDEX "idx_targets_org_metric" ON "targets" USING btree ("organization_id","metric_key");--> statement-breakpoint
...
CREATE POLICY "audit_logs_select_policy" ON "audit_logs" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "audit_logs_insert_policy" ON "audit_logs" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "customer_tag_assignments_select_policy" ON "customer_tag_assignments" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "customer_tag_assignments_insert_policy" ON "customer_tag_assignments" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "customer_tag_assignments_update_policy" ON "customer_tag_assignments" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "customer_tag_assignments_delete_policy" ON "customer_tag_assignments" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "product_relations_select_policy" ON "product_relations" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "product_relations_insert_policy" ON "product_relations" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "product_relations_update_policy" ON "product_relations" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "product_relations_delete_policy" ON "product_relations" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
...
CREATE POLICY "opportunities_select_policy" ON "opportunities" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "opportunities_insert_policy" ON "opportunities" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "opportunities_update_policy" ON "opportunities" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "opportunities_delete_policy" ON "opportunities" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "opportunity_activities_select_policy" ON "opportunity_activities" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "opportunity_activities_insert_policy" ON "opportunity_activities" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "opportunity_activities_delete_policy" ON "opportunity_activities" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "quote_versions_select_policy" ON "quote_versions" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "quote_versions_insert_policy" ON "quote_versions" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "quote_versions_update_policy" ON "quote_versions" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "quote_versions_delete_policy" ON "quote_versions" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
...
CREATE POLICY "quotes_select_policy" ON "quotes" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "quotes_insert_policy" ON "quotes" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "quotes_update_policy" ON "quotes" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "quotes_delete_policy" ON "quotes" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
...
CREATE POLICY "win_loss_reasons_select_policy" ON "win_loss_reasons" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "win_loss_reasons_insert_policy" ON "win_loss_reasons" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "win_loss_reasons_update_policy" ON "win_loss_reasons" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "win_loss_reasons_delete_policy" ON "win_loss_reasons" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "system_settings_select_policy" ON "system_settings" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "system_settings_insert_policy" ON "system_settings" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "system_settings_update_policy" ON "system_settings" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "system_settings_delete_policy" ON "system_settings" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "custom_fields_select_policy" ON "custom_fields" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "custom_fields_insert_policy" ON "custom_fields" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "custom_fields_update_policy" ON "custom_fields" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "custom_fields_delete_policy" ON "custom_fields" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
...
CREATE POLICY "data_exports_select_policy" ON "data_exports" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "data_exports_insert_policy" ON "data_exports" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "data_exports_update_policy" ON "data_exports" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "data_exports_delete_policy" ON "data_exports" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
...
CREATE POLICY "users_delete_policy" ON "users" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_delegations_select_policy" ON "user_delegations" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_delegations_insert_policy" ON "user_delegations" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_delegations_update_policy" ON "user_delegations" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_delegations_delete_policy" ON "user_delegations" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_group_members_select_policy" ON "user_group_members" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_group_members_insert_policy" ON "user_group_members" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_group_members_update_policy" ON "user_group_members" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_group_members_delete_policy" ON "user_group_members" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_groups_select_policy" ON "user_groups" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_groups_insert_policy" ON "user_groups" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_groups_update_policy" ON "user_groups" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_groups_delete_policy" ON "user_groups" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_invitations_select_policy" ON "user_invitations" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_invitations_insert_policy" ON "user_invitations" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_invitations_update_policy" ON "user_invitations" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "user_invitations_delete_policy" ON "user_invitations" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
...
CREATE POLICY "activities_select_policy" ON "activities" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "activities_insert_policy" ON "activities" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "campaign_recipients_select_policy" ON "campaign_recipients" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "campaign_recipients_insert_policy" ON "campaign_recipients" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "campaign_recipients_update_policy" ON "campaign_recipients" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "campaign_recipients_delete_policy" ON "campaign_recipients" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_campaigns_select_policy" ON "email_campaigns" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_campaigns_insert_policy" ON "email_campaigns" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_campaigns_update_policy" ON "email_campaigns" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_campaigns_delete_policy" ON "email_campaigns" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_history_select_policy" ON "email_history" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_history_insert_policy" ON "email_history" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_signatures_select_policy" ON "email_signatures" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_signatures_insert_policy" ON "email_signatures" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_signatures_update_policy" ON "email_signatures" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_signatures_delete_policy" ON "email_signatures" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_templates_select_policy" ON "email_templates" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_templates_insert_policy" ON "email_templates" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_templates_update_policy" ON "email_templates" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "email_templates_delete_policy" ON "email_templates" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "scheduled_calls_select_policy" ON "scheduled_calls" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "scheduled_calls_insert_policy" ON "scheduled_calls" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "scheduled_calls_update_policy" ON "scheduled_calls" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "scheduled_calls_delete_policy" ON "scheduled_calls" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "scheduled_emails_select_policy" ON "scheduled_emails" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "scheduled_emails_insert_policy" ON "scheduled_emails" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "scheduled_emails_update_policy" ON "scheduled_emails" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "scheduled_emails_delete_policy" ON "scheduled_emails" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
...
CREATE POLICY "attachments_delete_policy" ON "attachments" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
...
CREATE POLICY "search_index_select_policy" ON "search_index" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "search_index_insert_policy" ON "search_index" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "search_index_update_policy" ON "search_index" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "search_index_delete_policy" ON "search_index" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
...
CREATE POLICY "search_outbox_select_policy" ON "search_index_outbox" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "search_outbox_insert_policy" ON "search_index_outbox" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "search_outbox_update_policy" ON "search_index_outbox" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "search_outbox_delete_policy" ON "search_index_outbox" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "portal_sessions_select_policy" ON "customer_portal_sessions" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "portal_sessions_insert_policy" ON "customer_portal_sessions" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "portal_sessions_update_policy" ON "customer_portal_sessions" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "portal_sessions_delete_policy" ON "customer_portal_sessions" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "portal_identities_select_policy" ON "portal_identities" AS PERMISSIVE FOR SELECT TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid OR auth_user_id = auth.uid());--> statement-breakpoint
CREATE POLICY "portal_identities_insert_policy" ON "portal_identities" AS PERMISSIVE FOR INSERT TO "authenticated" WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "portal_identities_update_policy" ON "portal_identities" AS PERMISSIVE FOR UPDATE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid) WITH CHECK (organization_id = current_setting('app.organization_id', true)::uuid);--> statement-breakpoint
CREATE POLICY "portal_identities_delete_policy" ON "portal_identities" AS PERMISSIVE FOR DELETE TO "authenticated" USING (organization_id = current_setting('app.organization_id', true)::uuid);