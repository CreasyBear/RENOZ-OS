...
- raw `error.message` surfaces in remaining inventory dialogs/components, including create-PO-from-alert/recommendation and alert-list read presentation
