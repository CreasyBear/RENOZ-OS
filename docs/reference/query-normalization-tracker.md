...
| `tests/unit/inventory/query-normalization-wave3-analytics.test.tsx` | inventory analytics wave test | n/a | hook and consumer verification | n/a | n/a | self | `in progress` | Covers valuation/aging/turnover analytics contract and unavailable-vs-empty tab policy. |
| `tests/unit/inventory/query-normalization-wave3-movements.test.tsx` | inventory movements wave test | n/a | hook and consumer verification | n/a | n/a | self | `in progress` | Covers movement list success, empty-state semantics, and degraded stale-data rendering. |
| `tests/unit/inventory/query-normalization-wave3-dashboard.test.tsx` | inventory dashboard wave test | n/a | hook and consumer verification | n/a | n/a | self | `in progress` | Covers WMS/dashboard hook semantics plus full-page vs degraded panel policy. |
