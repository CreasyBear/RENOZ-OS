...
describe('supplier price-list upsert contract', () => {
  it('throws an operator-safe error when direct price-list upsert returns no row', () => {
    ...
    expect(block).toContain(
      'if(!result){thrownewValidationError("Supplierpricelistcouldnotbesaved.Refreshandtryagain.");}'
    );
