...
type ProcurementDashboardRange = 'week' | 'month' | 'quarter' | 'year';

interface ProcurementDashboardSearchState {
  range: ProcurementDashboardRange;
  from?: string;
  to?: string;
}

interface ProcurementDashboardPageProps {
  search?: ProcurementDashboardSearchState;
  navigate?: (options: {
    search: (prev: ProcurementDashboardSearchState) => ProcurementDashboardSearchState;
    replace?: boolean;
  }) => void;
}
