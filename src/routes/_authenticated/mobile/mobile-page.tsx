 ...
 *
 * @source online status from useOnlineStatus hook
 *
 * @see src/routes/_authenticated/mobile/index.tsx - Route definition
 */
    ...
    <div className="min-h-dvh bg-muted/30">
      ...
      <div className="px-4 space-y-3">
        ...
        <MobileActionButton
          ...
          onClick={() => navigate({ to: "/mobile/picking" })}
          variant="default"
        />
        ...
        <MobileActionButton
          ...
          onClick={() => navigate({ to: "/mobile/counting" })}
          variant="warning"
        />
      </div>
