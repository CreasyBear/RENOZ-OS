/**
 * New Opportunity Page Component
 *
 * Form for creating a new opportunity in the pipeline.
 * Handles form state, validation, and submission.
 *
 * @source customers from useCustomers hook
 * @source createOpportunity from useCreateOpportunity hook
 *
 * @see src/routes/_authenticated/pipeline/new.tsx
 */
