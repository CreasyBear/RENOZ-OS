...
const SAMPLE_DOCUMENT_DATA: PreviewDocumentData & {
  ...
  organization: {
    name: 'RENOZ Energy',
    email: 'operations@renoz.energy',
    phone: '(555) 123-4567',
    address: '18 Energy Circuit',
    city: 'Perth',
    state: 'WA',
    postalCode: '6000',
    country: 'Australia',
  ...
  customer: {
    name: 'West Coast Solar Supply',
    email: 'procurement@westcoastsolar.example',
    phone: '(555) 987-6543',
    address: '42 Distribution Drive',
    city: 'Fremantle',
    state: 'WA',
    postalCode: '6160',
    country: 'Australia',
  ...
  order: {
    ...
    lineItems: [
      {
        description: 'RENOZ 5.12 kWh LiFePO4 Battery Module',
        quantity: 24,
        unitPrice: 1850.0,
        total: 44400.0,
      },
      {
        description: 'Battery Cabinet - Wall Mount 30 kWh',
        quantity: 4,
        unitPrice: 1650.0,
        total: 6600.0,
      },
      {
        description: 'Hybrid Inverter Communication Harness',
        quantity: 8,
        unitPrice: 145.0,
        total: 1160.0,
      },
      {
        description: 'Commissioning Pack and Warranty Registration',
        quantity: 1,
        unitPrice: 750.0,
        total: 750.0,
      },
    ...
    taxAmount: 5291.0,
    discount: 0,
    shippingAmount: 480.0,
    paidAmount: 0,
    balanceDue: 58681.0,
    total: 58681.0,
    notes: 'Dispatch from RENOZ warehouse after serial scan and QA release.',
    terms:
      'Payment due within 14 days. Warranty activation requires verified serial numbers and commissioning details.',
  },
  warranty: {
    certificateNumber: 'WC-2026-0001',
    productName: 'RENOZ 5.12 kWh LiFePO4 Battery Module',
    serialNumber: 'RZB-5120-2026-000123',
    coverageYears: 7,
    startDate: new Date().toISOString(),
    endDate: new Date(Date.now() + 7 * 365 * 24 * 60 * 60 * 1000).toISOString(),
    terms: 'Covers eligible manufacturing defects when installation and commissioning records are complete.',
  },
  job: {
    jobNumber: 'SRV-2026-0001',
    title: 'Battery Bank Commissioning Support',
    description: 'Commissioning support for a commercial lithium battery bank supplied by RENOZ Energy.',
    scheduledDate: new Date(Date.now() + 7 * 24 * 60 * 60 * 1000).toISOString(),
    tasks: [
      { name: 'Verify received battery serial numbers', completed: false },
      { name: 'Confirm inverter communication settings', completed: false },
      { name: 'Record commissioning measurements', completed: false },
      { name: 'Register warranty entitlements', completed: false },
      { name: 'Complete handover documentation', completed: false },
    ],
    materials: [
      { name: 'RENOZ 5.12 kWh Battery Module', quantity: 6 },
      { name: 'CAN Communication Lead', quantity: 2 },
      { name: 'Battery Cabinet Label Set', quantity: 1 },
      { name: 'Commissioning Checklist', quantity: 1 },
    ],
  },
};
      ...
      if (entityType === 'order') {
        ...
        const [customerResult, lineItemsResult, billingAddressResult, shippingAddressResult, primaryAddressResult] = await Promise.all([
          ...
          db
            ...
            .where(
              and(
                eq(orderLineItems.orderId, entityId),
