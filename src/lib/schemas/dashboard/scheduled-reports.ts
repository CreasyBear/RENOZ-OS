 ...
 * Dashboard is the canonical owner per sprint-plan S9-T04.
 * Matches enums from drizzle/schema/dashboard/scheduled-reports.ts
 *
 * @see drizzle/schema/dashboard/scheduled-reports.ts
