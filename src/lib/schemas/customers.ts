...
export const customerSizeValues = [
  "micro",
  "small",
  "medium",
  "large",
...
export const activityDirectionValues = [
  "inbound",
  "outbound",
  "internal",
] as const;

export const customerPriorityLevelValues = [
  "low",
  "medium",
  "high",
  "vip",
...
export const serviceLevelValues = [
  "standard",
  "premium",
  "platinum",
] as const;
 ...
 */
export const customerCustomFieldsSchema = z.record(
  z.string(),
...
export const customerSchema = createCustomerSchema.extend({
  ...
  totalOrderValue: z.number().nullable(),
...
export const createCustomerHealthMetricSchema = z.object({
  ...
  frequencyScore: z.number().min(0).max(100).optional(),
  monetaryScore: z.number().min(0).max(100).optional(),
