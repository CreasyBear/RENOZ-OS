 ...
 * - Bulk operations
 *
 * @see src/server/functions/reports/scheduled-reports.ts
 * @see src/lib/schemas/reports/scheduled-reports.ts
 */
...
export function useCreateScheduledReport() {
  ...
  return useMutation({
    ...
    onSuccess: (result) => {
      queryClient.setQueryData(queryKeys.reports.scheduledReports.detail(result.id), result);
      queryClient.invalidateQueries({ queryKey: queryKeys.reports.scheduledReports.lists() });
    },
  });
}
...
export function useUpdateScheduledReport() {
  ...
  return useMutation({
    ...
    onSuccess: (result, variables) => {
      queryClient.setQueryData(queryKeys.reports.scheduledReports.detail(variables.id), result);
      queryClient.invalidateQueries({ queryKey: queryKeys.reports.scheduledReports.lists() });
      queryClient.invalidateQueries({
        queryKey: queryKeys.reports.scheduledReports.status(variables.id),
      });
    },
  });
}
...
export function useDeleteScheduledReport() {
  ...
  return useMutation({
    ...
    onSuccess: (_, id) => {
      queryClient.removeQueries({ queryKey: queryKeys.reports.scheduledReports.detail(id) });
      queryClient.removeQueries({ queryKey: queryKeys.reports.scheduledReports.status(id) });
      queryClient.invalidateQueries({ queryKey: queryKeys.reports.scheduledReports.lists() });
    },
  });
}
