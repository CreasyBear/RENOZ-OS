  ...
  return useMutation({
    ...
    onSuccess: (result, variables) => {
      ...
      if (result.success) {
        ...
        toast.error(formatWarrantyCertificateResultError(result.error));
      }
    },
    onError: (error) => {
      toast.error(formatWarrantyCertificateMutationError(error, 'generate'));
    },
  });
}
...
export function useRegenerateWarrantyCertificate() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast.error(formatWarrantyCertificateMutationError(error, 'regenerate'));
    },
  });
}
