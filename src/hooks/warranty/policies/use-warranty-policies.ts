...
export function useCreateWarrantyPolicy() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast.error(formatWarrantyPolicyMutationError(error, 'create'));
    },
  });
}
...
export function useUpdateWarrantyPolicy() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast.error(formatWarrantyPolicyMutationError(error, 'update'));
    },
  });
}
...
export function useDeleteWarrantyPolicy() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast.error(formatWarrantyPolicyMutationError(error, 'delete'));
    },
  });
}
...
export function useSetDefaultWarrantyPolicy() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast.error(formatWarrantyPolicyMutationError(error, 'setDefault'));
    },
  });
}
...
export function useSeedDefaultWarrantyPolicies() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast.error(formatWarrantyPolicyMutationError(error, 'seedDefaults'));
    },
  });
}
...
export function useAssignWarrantyPolicyToProduct() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast.error(formatWarrantyPolicyMutationError(error, 'assignProduct'));
    },
  });
}
...
export function useAssignDefaultWarrantyPolicyToCategory() {
  ...
  return useMutation({
    ...
    onError: (error) => {
      toast.error(formatWarrantyPolicyMutationError(error, 'assignCategory'));
    },
  });
}
