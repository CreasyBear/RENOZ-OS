...
export function useInventoryRealtime(
  ...
  return useRealtimeBroadcast<InventoryRealtimePayload>({
    ...
    queryKeys: [
      ...
      queryKeys.inventory.details(),
      queryKeys.inventory.items({ organizationId }),
      queryKeys.inventory.movementsAll(),
      queryKeys.inventory.alertsAll(),
      queryKeys.products.stock(),
      queryKeys.products.inventories(),
      queryKeys.products.inventoryStatsAll(),
      queryKeys.products.stockLevelsAll(),
      queryKeys.products.stockAlertsAll(),
      queryKeys.products.movementsAll(),
