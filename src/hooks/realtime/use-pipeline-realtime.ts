...
export function usePipelineRealtime(
  ...
  return useRealtimeBroadcast<PipelineRealtimePayload>({
    ...
    queryKeys: [
      ...
      queryKeys.opportunities.infiniteLists(),
      queryKeys.opportunities.details(),
      queryKeys.opportunities.hotLeads(),
      queryKeys.pipeline.board(),
      queryKeys.pipeline.stages(),
      queryKeys.pipeline.metrics(),
      queryKeys.quotes.lists(),
      queryKeys.quotes.details(),
