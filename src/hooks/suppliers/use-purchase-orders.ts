  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        if (result == null) {
          throw new Error('Purchase order list returned no data');
        }
        return result;
      } catch (error) {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        if (result == null) {
          throw new Error('Pending approvals returned no data');
        }
        return result;
      } catch (error) {
        throw normalizeReadQueryError(error, {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        if (result == null) {
          throw new Error('Receiving dashboard summary returned no data');
        }
        return result;
      } catch (error) {
        throw normalizeReadQueryError(error, {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        if (result == null) {
          throw new Error('Purchase order status counts returned no data');
        }
        return result;
      } catch (error) {
        throw normalizeReadQueryError(error, {
  ...
  return useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        if (result == null) {
          throw new Error('Purchase order detail returned no data');
        }
        return result;
      } catch (error) {
        throw normalizeReadQueryError(error, {
