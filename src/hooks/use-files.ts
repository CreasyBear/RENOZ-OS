...
export const fileKeys = {
  ...
  download: (attachmentId: string) =>
    [...fileKeys.all, "download", attachmentId] as const,
  downloads: (attachmentIds: string[]) =>
    [...fileKeys.all, "downloads", attachmentIds.sort().join(",")] as const,
};
...
export function useAttachments(
  ...
  return useQuery({
    queryKey: fileKeys.list(entityType, entityId),
    queryFn: () =>
      listAttachments({
        data: {
          entityType,
...
export function useDownloadUrl(
  ...
  return useQuery({
    queryKey: fileKeys.download(attachmentId ?? ""),
    ...
    onSuccess: (_data, variables) => {
      ...
      if (variables.entityType && variables.entityId) {
        queryClient.invalidateQueries({
          queryKey: fileKeys.list(variables.entityType, variables.entityId),
        });
      }
    },
  });
