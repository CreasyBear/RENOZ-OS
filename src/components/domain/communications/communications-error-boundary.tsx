/**
 * Communications Error Boundary
 *
 * Error boundary for communications domain components with graceful fallback UI.
...
export class CommunicationsErrorBoundary extends Component<Props, State> {
  ...
  componentDidCatch(error: Error, errorInfo: React.ErrorInfo) {
    logger.error('Communications error boundary caught error', error, {
