...
export const FollowUpScheduler = memo(function FollowUpScheduler({
  ...
  const { data, isLoading, error } = useQuery<FollowUpsResponse>({
    queryKey: ["follow-ups", opportunityId],
    queryFn: async () => {
  ...
  const scheduleMutation = useMutation({
    ...
    onSuccess: () => {
      ...
      queryClient.invalidateQueries({ queryKey: ["follow-ups", opportunityId] });
      queryClient.invalidateQueries({ queryKey: ["activity-timeline", opportunityId] });
