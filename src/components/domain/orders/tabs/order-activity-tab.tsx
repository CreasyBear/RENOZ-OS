 ...
 * Order Activity Tab
 *
 * Displays the unified activity timeline for an order.
 * Shows all changes, events, and communications.
...
export interface OrderActivityTabProps {
...
export const OrderActivityTab = memo(function OrderActivityTab({
  activities,
  isLoading = false,
  error,
  onLogActivity,
  onScheduleFollowUp,
}: OrderActivityTabProps) {
  return (
