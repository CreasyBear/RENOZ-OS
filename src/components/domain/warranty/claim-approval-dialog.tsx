...
import type { WarrantyClaimTypeValue, WarrantyClaimStatusValue } from '@/lib/schemas/warranty/claims';
import {
  claimTypeConfig,
  claimStatusConfig,
  formatClaimCost,
...
export function ClaimApprovalDialog({
  ...
  const statusCfg = claimStatusConfig[claim.status as WarrantyClaimStatusValue];
        ...
        {!canDecide ? (
          <div className="py-4 text-center">
            ...
            <p className="text-muted-foreground">
              This claim has status <Badge className={statusCfg?.color}>{statusCfg?.label}</Badge>{' '}
