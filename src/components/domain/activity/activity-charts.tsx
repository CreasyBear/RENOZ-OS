 ...
 * ```
 */
export function ActivityTrendChart({ dateFrom, dateTo, className }: ActivityTrendChartProps) {
 ...
 * ```
 */
export function EntityBreakdownChart({ dateFrom, dateTo, className }: EntityBreakdownChartProps) {
  const { data, isLoading, isError } = useActivityStats({
    dateFrom,
    dateTo,
    groupBy: 'entityType',
